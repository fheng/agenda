...
Agenda.prototype.every = function(interval, names, data, options) {
  var self = this;
  ...
  function createJob(interval, name, data, options) {
  ...
  function createJobs(interval, names, data,options) {
